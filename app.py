        ...
        if res.status_code == 200:
            ...
            if data_list:
                ...
                for _, row in latest_data.iterrows():
                    ...
                    elif "投信" in name or "investment" in name or "trust" in name:
